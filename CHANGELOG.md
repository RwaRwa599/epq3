...
| `block1` B1.12 | CHECK-UP bar is grid origin | labform extra patient header no longer uses a fixed page-top y | Per-field template-row bugs (batchsample7) still second-order |
