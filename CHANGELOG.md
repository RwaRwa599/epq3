...
| `block1` B5 | withhold LIS ticks on registration_failure | block5-3: 5 sheets, 0 gold TP (7598 1/7 hav only); 1c hitl 0–17% so wrong squares look valid | Empty LIS order when the page gate fires; registration still the limiter |
