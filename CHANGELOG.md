...
| `block1` if1 | `run_blocks_1_to_5(..., if1=True)` + `prototype3.ipynb` (`BOOTSTRAP_V9`) | Default path unchanged (`if1=False`); Bayesian group fit is a placeholder | Counts for \(w,\pi\); two-tier LabOrder |
